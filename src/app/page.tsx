...
import { Carousel, CarouselContent, CarouselItem, CarouselPrevious, CarouselNext } from "@/components/ui/carousel"; // Импорт компонентов карусели
import { Switch } from "@/components/ui/switch"; // Импорт компонента Switch
import { Label } from "@/components/ui/label"; // Импорт компонента Label
import { Sun, Moon } from "lucide-react"; // Импорт иконок
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 dark:from-gray-800 dark:via-gray-900 dark:to-black flex flex-col items-center p-4 sm:p-6">
      <div className="max-w-4xl w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4 sm:p-8 border border-gray-200 dark:border-gray-700">
        ...
        <p className="text-gray-700 dark:text-gray-300 text-center text-base sm:text-lg mb-2 font-bebas-neue">+48 576 212 418 | <a href="mailto:fodi85999@gmail.com" className="text-blue-600 dark:text-blue-400 hover:underline">fodi85999@gmail.com</a></p>
        <p className="text-gray-700 dark:text-gray-300 text-center text-base sm:text-lg mb-4 font-bebas-neue"><a href="https://instagram.com/fodifood" className="text-pink-600 dark:text-pink-400 hover:underline">Instagram: @fodifood</a></p>
            ...
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-4 font-bebas-neue">
              ...
              <li>
                ...
                <ul className="ml-4 list-disc list-inside space-y-2">
                  ...
                  <li>Badanie jakości, zwiększanie trwałości</li>
